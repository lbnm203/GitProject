...
public class ProductDetailMenu {
    ...
    public static void productMenu() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1 -> SubAddProductMenu.addProductMenu();
                case 2 -> {
                    ...
                    if (productName.isEmpty()) {
                        ...
                        SubSearchProductMenu.searchMenu();
                    }
                }
                case 3 -> {
    ...
    public static void showProductMenu() {
        System.out.println("""
                ============MENU CHI TIẾT SẢN PHẨM============g
                  1. Thêm mặt hàng vào giỏ hàng
                  2. Tìm kiếm mặt hàng theo tên
                  3. Tìm kiếm mặt hàng theo giá tiền
                  4. Tìm kiếm mặt hàng theo loại hàng (type)
